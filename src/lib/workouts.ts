...
export const treinos: Treinos = {
  'treino 1': [
    ...
    { nome: 'Remada sentada triângulo', descricao: '1 série de 15, 1 série de 10 e 1 série de 8 aumente a carga em cada série', videoURL: ['PTXq4-McnuM?si=xHbw3FBAcJJWSl7O'] },
    { nome: 'Crucifixo inclinado', descricao: '1 série de 15, 1 série de 10 e 1 série de 8 aumente a carga em cada série', videoURL: ['WP1VLAt8hbM?si=KuOoUuPy7ZbNcpCH'] },
    { nome: 'Desenvolvimento ombros livre ou máquina', descricao: '1 série de 15, 1 série de 10 e 1 série de 8 aumente a carga em cada série', videoURL: ['B7XVbxW7ng4?si=Ub3qf2-DMyGw_BZ5'] },
  ...
  'treino 2': [
    ...
    { nome: 'Supino Reto', descricao: '1 série de 15, 1 série de 10 e 1 série de 8 aumente a carga em cada série', videoURL: ['eg9BbzwUiG0?si=Z0CfhLpsO0kMyl-W'] },
